...
- Ecrire un programme C minimal.
- Compiler et executer dans le navigateur.
...
- Compiler Explorer : compiler et executer un programme court.
- Copier-coller les exercices `exercices/seance-01/*/main.c`.
